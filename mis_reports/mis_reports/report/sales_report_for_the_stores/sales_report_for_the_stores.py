...
def get_column():
	return [_("Date") + ":Date:90",_("Category") + ":Data:90",_("Subcategory") + ":Data:110",_("Size") + ":Data:90",_("Color") + ":Data:105",_("Sales Invoice") + ":Data:110",_("Qty") + ":Float:105",_("Rate") + ":Float:105",_("Discount") + ":Float:105",_("Salesman") + ":Data:105"]
